...
from src.bot.routers.registration import router
from src.bot.routers.registration.keyboards import (
...
from src.bot.routers.registration.states import RegistrationStates, RefillProfileStates
from src.bot.routers.registration.utils import is_cyrillic
